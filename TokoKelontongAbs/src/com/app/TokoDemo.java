...
public class TokoDemo {
	...
	public static void main(String[] args) {
		...
		Toko toko = new Toko("Sejahtera", 10, new Promo(0.1, 0.25, 0.35));
		...
		toko.tambahkanProduk(new Produk(3, "Tas", 100000, "Produk 3", 100));
		toko.tambahkanProduk(new Produk(4, "Jam", 900000, "Produk 4", 250));
		...
		Pembeli joni = new Pembeli("Joni", 35, 2000000);
		toko.daftarMember(joni, MemberType.GOLD, 10000);
